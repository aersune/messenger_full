...
class ChatService extends ChangeNotifier {
  ...
  Future<void> getUserData() async {
    ...
    // print('🔥 Original photoUrl: ${data['photoUrl']}');
    //
    // // 🔧 URL’ni to‘g‘rilaymiz
    // if (data['photoUrl'] != null) {
    //   data['photoUrl'] = data['photoUrl'].toString().replaceAll('.firebasestorage.app', '.firebaseio.com');
    //   print('✅ Fixed photoUrl: ${data['photoUrl']}');
    // }
